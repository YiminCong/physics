...
**定义。** **电弱理论**（格拉肖、萨拉姆、温伯格，1967–68 年）在规范群 SU(2)_L × U(1)_Y 的单一规范理论框架内统一了电磁力与弱核力。SU(2)_L 因子仅作用于左手费米子双重态（如 (ν_e, e)_L 和 (u, d)_L），具有三个规范场 Wμ^{1,2,3}。U(1)_Y 因子引入与**弱超荷** Y 相关的单一场 Bμ。这四个规范场发生混合：物理质量本征态为带电的 W± = (Wμ^1 ∓ iWμ^2)/√2，中性的 Z⁰ = Wμ^3 cos θ_W − Bμ sin θ_W，以及光子 Aμ = Wμ^3 sin θ_W + Bμ cos θ_W，其中 θ_W ≈ 28.7° 为**温伯格角**。电荷为 e = g sin θ_W = g' cos θ_W，g、g' 分别为 SU(2) 和 U(1) 的耦合常数。若无额外成分，对称性严格成立，所有规范玻色子无质量——这与弱力的观测短程性相矛盾。
...
**演示。** 弱力由 W±（改变电荷，例如 β 衰变中的 n → p + e⁻ + ν̄_e）和 Z⁰（中性流，例如 νμ e⁻ → νμ e⁻）传递。在低能量 q² ≪ m_W² 下，W 传播子退化为接触相互作用，费米常数 G_F/√2 = g²/(8m_W²) ≈ 1.17 × 10⁻⁵ GeV⁻²。短程 r ~ ℏ/(m_W c) ~ 10⁻¹⁸ m 直接源于 W 玻色子的大质量（m_W ≈ 80.4 GeV，m_Z ≈ 91.2 GeV）。这些质量必须在不破坏规范不变性的前提下产生——这正是希格斯机制的任务。
...
**应用。** SU(2) × U(1) 结构统一了四种基本力中的两种：在远超 m_Z 的能量下，电磁相互作用与弱相互作用具有相当的强度。W± 和 Z⁰ 玻色子于 1983 年在欧洲核子研究中心被发现，质量与预言完全一致。标准模型电弱部分在大型正负电子对撞机和大型强子对撞机上的检验精度优于百分之一，其确认程度堪比量子电动力学。
...
**定义。** **希格斯机制**是将自发对称性破缺（模块 2.3）应用于电弱真空的规范对称性。向理论中添加一个具有 SU(2)_L × U(1)_Y 量子数的复标量双重态 φ = (φ⁺, φ⁰)，并赋予其**墨西哥帽势** V(φ) = −μ²φ†φ + λ(φ†φ)²。当 μ² > 0 时，极小值位于 |φ|² = v²/2，其中 v = √(μ²/λ) ≈ 246 GeV——即**真空期望值**。真空选择方向 ⟨φ⟩ = (0, v/√2)，将 SU(2)_L × U(1)_Y 自发破缺至 U(1)_EM。这在数学上与金兹堡–朗道自由能（模块 5.3）和超导体中的安德森机制（模块 5.3）完全相同：光子在超导体内部获得质量；而在这里，W± 和 Z⁰ 在宇宙的真空中获得质量。
...
**演示。** 将 φ 在极小值附近展开，φ = (0, (v + h)/√2)，代入规范动能项 |Dμφ|²，规范场的二次项产生质量：m_W = gv/2，m_Z = √(g² + g'²) v/2 = m_W/cos θ_W。三个戈德斯通模式（来自破缺 SU(2) 方向的原本无质量的标量）被吸收为 W± 和 Z⁰ 的纵向极化——每个规范玻色子的自由度从 2（横向）增加到 3（横向 + 纵向），恰好对应于被"吃掉"的标量。剩下一个实标量自由度：**希格斯玻色子 h**，质量为 m_h = √(2μ²) = √(2λ) v。费米子质量来自汤川耦合 ℒ_Yukawa = −y_f ψ̄_L φ ψ_R + h.c.，对称性破缺后给出 m_f = y_f v/√2；顶夸克的汤川耦合常数 y_t ≈ 1。
...
**应用。** 希格斯玻色子于 2012 年在欧洲核子研究中心大型强子对撞机（ATLAS 和 CMS 实验）上被发现，质量 m_h ≈ 125 GeV——这是 45 年前建立的标准模型的巨大胜利。它与 W、Z 及费米子的耦合随质量的缩放完全符合预言。希格斯机制是课程中最优美的单一交叉联系：同一套自发对称性破缺数学，既解释了超导体中的迈斯纳效应（第 5 阶段），也解释了为何弱力是短程的以及为何所有基本粒子都有质量。
...
1. 解释为何非零真空期望值 ⟨φ⟩ = v/√2 赋予 W± 和 Z⁰ 质量而使光子保持无质量。哪个对称性被保留？
2. 画出墨西哥帽势。指出戈德斯通模式和希格斯方向。解释 W 和 Z 的纵向极化从何而来。
3. 写出顶夸克的汤川耦合，并证明它如何产生狄拉克质量 m_t = y_t v/√2。在此框架下，为何顶夸克质量相比电子质量如此之大？
