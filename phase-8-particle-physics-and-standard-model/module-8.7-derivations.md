...
Using the identity P_Rγ^μ = γ^μP_L (from {γ^μ, γ⁵} = 0, i.e. (1+γ⁵)γ^μ = γ^μ(1−γ⁵)) together with P_L² = P_L:

利用恒等式 P_Rγ^μ = γ^μP_L（来自 {γ^μ, γ⁵} = 0，即 (1+γ⁵)γ^μ = γ^μ(1−γ⁵)）以及 P_L² = P_L：

  ψ̄_Lγ^μψ'_L = ψ̄(P_Rγ^μP_L)ψ' = ψ̄(γ^μP_LP_L)ψ' = ψ̄γ^μP_Lψ'. So:

  ψ̄_Lγ^μψ'_L = ψ̄(P_Rγ^μP_L)ψ' = ψ̄(γ^μP_LP_L)ψ' = ψ̄γ^μP_Lψ'。故：
