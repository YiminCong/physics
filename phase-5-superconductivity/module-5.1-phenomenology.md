...
**Application.** Any theory must reproduce these facts. The **isotope effect** — $T_c \propto M^{-1/2}$ in the ionic mass — is the crucial clue that **phonons** (Phase 4) mediate the pairing, pointing the way to BCS.
