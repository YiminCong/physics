...
**Definition.** Type II superconductors (κ > 1/√2) don't expel field entirely. Between a lower field **H_c1** and an upper field **H_c2** they enter a **mixed state**: magnetic field penetrates as an array of **quantized flux vortices**, each carrying one flux quantum Φ₀ = h/2e around a normal core.

**定义。** II 型超导体（κ > 1/√2）不能完全排斥磁场。在下临界场 **H_c1** 和上临界场 **H_c2** 之间，它们进入**混合态**：磁场以**量子化磁通涡旋**阵列的形式穿入，每个涡旋围绕一个正常态核心携带一个磁通量子 Φ₀ = h/2e。
