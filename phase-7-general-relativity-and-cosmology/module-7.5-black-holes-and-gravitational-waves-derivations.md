...
**Step 5 — Application to binary orbit.** For two equal masses M in circular orbit of radius r (separation 2r, orbital frequency Ω = √(2GM/(2r)³)^{1/2}... more precisely Ω² = GM_tot/(2r)³ for reduced mass), the quadrupole components are Q_{ij} ~ Mr² cos(2Ωt). Taking three time derivatives gives Q‴_{ij} ~ 8Ω³Mr² sin(2Ωt), and ⟨(Q‴)²⟩ = 32 M²r⁴Ω⁶. Substituting:

**第 5 步 — 应用于双星轨道。** 对于两个等质量 M 在半径 r 的圆轨道（间距 2r，轨道频率 Ω），四极矩分量为 Q_{ij} ~ Mr² cos(2Ωt)。取三阶时间导数得 Q‴_{ij} ~ 8Ω³Mr² sin(2Ωt)，⟨(Q‴)²⟩ = 32 M²r⁴Ω⁶。代入：

  P = (G/5c⁵) · 32 M²r⁴Ω⁶ = (32/5) G M²r⁴Ω⁶/c⁵.

Using Kepler's third law Ω² = GM/(2r)³ for each mass (total mass 2M, semi-major axis 2r):
